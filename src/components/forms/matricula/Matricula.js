                    ...
                    <td>
                      <div className="form-group">
                        <input type="text" name={conceptoId} id={conceptoId} 
                          placeholder="210-010"  data-id={idx} value={rowState[idx].concepto}
                          onChange={handleRowChange} className="concepto form-control" readOnly />
                      </div>  
                    </td>
                    <td>
                      <div className="form-group">
                        <input type="text" name={montoId} id={montoId} 
                          placeholder="56"  data-id={idx} value={rowState[idx].monto}
                          onChange={handleRowChange} className="monto form-control" readOnly/>
                      </div>  
                    </td>
                    <td> 
